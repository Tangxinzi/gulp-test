$(document).ready(function() {
  ...
  console.log("\n\n".concat(" %c 白马映画", " Baima Picture ").concat("%c 媒体联络 baimapicture@163.com ", "\n\n"), "color: #ffffff; background: #8d1070; padding: 5px 0;", "color: #ffffff; background: #fea01b; padding: 5px 0;")
})
